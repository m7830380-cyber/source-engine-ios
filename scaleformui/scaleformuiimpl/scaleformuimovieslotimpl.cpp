...
ConVar sf_ios_flip_menu( "sf_ios_menu_flip", "1", FCVAR_NONE, "iOS: menu orientation, 0 none, 1 flip vertical, 2 flip horizontal, 3 both" );
ConVar sf_ios_flip_hud( "sf_ios_hud_flip", "1", FCVAR_NONE, "iOS: in-game HUD orientation, 0 none, 1 flip vertical, 2 flip horizontal, 3 both" );
